...
/**
 * Created by viruser on 2019/10/10.
 */
public class SynchronizedTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 但是如果执行了hashCode（identity hashcode，重载过的hashCode方法则不受影响），
        // 会导致偏向锁的标识位变为0（不可偏向状态），
...
//                lock.hashCode();
        ...
        synchronized (lock) {
            int i = 123;
            // 注意：6_轻量级锁 和 8_轻量级锁 的对象头是一样的，证明线程释放锁后，栈帧中的锁记录并未清除，
            // 如果方法返回，锁记录是否保留还是清除？
